...
// Dùng 1 icon mặc định cho toàn bộ hệ thống bản đồ
const defaultStationIcon = new L.Icon.Default();

export const getStationIcon = (_station: Station, _isPlanned: boolean = false) => {
